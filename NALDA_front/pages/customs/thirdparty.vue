          ...
          <div class="terms-box">
            ...
            <div class="article">
              ...
              <p class="article-text">
                ...
                날다 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일,
                캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를
                이용하기 위해 회원가입을 할 경우, 날다는 서비스 이용을 위해
                필요한 최소한의 개인정보를 수집합니다.
              </p>
              <div class="clause">
                <h4 class="clause-title">
                  회원가입 시점에 날다가 이용자로부터 수집하는 개인정보는 아래와
                  같습니다.
                </h4>
                <ul class="sections">
                ...
                <p class="clause-text">
                  ...
                  마스킹 처리된 아이디가 별명으로 자동 입력됩니다.
                </p>
                <p class="clause-text">
                  날다 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서
                  해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수
                  있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집
                  시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집
                  및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를
                  받습니다.
                </p>
                <h4 class="clause-title">
                  서비스 이용 과정에서 IP 주소, 쿠키, 서비스 이용 기록,
                  기기정보, 위치정보가 생성되어 수집될 수 있습니다. 또한 이미지
              ...
              <div class="clause">
                ...
                <ul class="sections">
                  <li class="sections-section">
                    ...
                    <br />탈퇴한 이용자의 휴대전화번호(복호화가 불가능한 일방향
                  ...
                  <li class="sections-section">
                    ...
                    <br />암호화처리(해시처리)한DI :혜택 제공 종료일로부터6개월
                    보관
                  </li>
                  <li class="sections-section">
